...
const ProductDetails = () => {
    ...
    const addReview = event => {
        ...
        fetch(`https://ass12-crud-server3.vercel.app/techProduct/${id}/addReview`,{
            method: 'POST',
            headers: {
    ...
    const handleUpvote = () => {
        ...
        if (!hasUpvoted) {
          ...
          fetch(`https://ass12-crud-server3.vercel.app/techProduct/${_id}`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            },
...
const addReport = () => {
  ...
  const id = "656b330f342a31a0dac19fb0";
  ...
  .then(data =>{
    ...
    if(data.modifiedCount > 0){
      ...
      .then((updatedUserData) => {
        ...
        console.log("szdgjmhj",updatedUserData);
...
<>
{
    ...
    <h2 className="bg-green-400 rounded-md px-2 py-1 flex items-center gap-1 w-[50px] justify-center">
      ...
      {currentVote -1}
        ...
        className=" bg-red-500 text-white px-2 py-1 rounded-lg w-[100px] mt-4">
          Report
        </button>
