...
fetch(`https://ass12-crud-server3.vercel.app/users/${user._id}`, {
    method: 'PUT',
    headers: {
...
.then(data =>{
  ...
  if(data.modifiedCount > 0){
    ...
    fetch('https://ass12-crud-server3.vercel.app/users')
    .then((res) => res.json())
    ...
    const handleDeleteUser = id =>{
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              fetch(`https://ass12-crud-server3.vercel.app/users/${id}`,{
                method: 'DELETE'
              })
              .then(res=> res.json())
              .then(data => {
