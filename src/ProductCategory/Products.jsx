...
// const products = filterPending.filter(item => item.type === 'accepted');
...
useEffect(() => {
    fetch(`https://ass12-crud-server3.vercel.app/techProduct?page=${currentPage}&size=${itemsPerPage}`)
    .then(res => res.json())
...
useEffect(() => {
    fetch('https://ass12-crud-server3.vercel.app/productsCount')
    .then(res => res.json())
